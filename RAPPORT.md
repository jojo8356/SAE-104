...
- OK Menu mobile hamburger avec animation
...
├── aides.md                    # Documentation ligne par ligne
│
...
│   │   └── templates/          # 5 templates HTML (responsive)
│   ├── config/
│   │   ├── settings.py         # Config avec python-dotenv
│   │   └── urls.py
│   └── manage.py
│
├── scripts/                    # Scripts d'automatisation
│   ├── install.sh              # Installation BD + venv
│   ├── migrate.sh              # Migrations (optimisé)
...
# Tests backend uniquement (après activation du venv)
cd carte_grise_app
source .venv/bin/activate
python manage.py test cartes_grises.test_views --keepdb
```
